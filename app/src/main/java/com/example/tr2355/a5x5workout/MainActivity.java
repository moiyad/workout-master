...
public class MainActivity extends AppCompatActivity {
    ...
    public void fillTheGUI(Double squat,Double benchPress,Double barBellRow,Double overHeadPress,Double deadLift){
        ...
        squatTotal.setText(String.valueOf(d.intValue()) +" Kg");

        d= benchPress*2+20;
        benchPressR.setText(String.valueOf(benchPress));
        benchPressTotal.setText(String.valueOf(d.intValue())+" Kg");


        d=barBellRow*2+20;
        barBellRowR.setText(String.valueOf(barBellRow));
        barBellRowTotal.setText(String.valueOf(d.intValue())+" Kg");

        d= overHeadPress*2+20;
        overHeadPressR.setText(String.valueOf(overHeadPress));
        overHeadPressTotal.setText(String.valueOf(d.intValue())+" Kg");

        d=deadLift*2+20;
        deadLifR.setText(String.valueOf(deadLift));
        deadLiftTotal.setText(String.valueOf(d.intValue())+" Kg");
